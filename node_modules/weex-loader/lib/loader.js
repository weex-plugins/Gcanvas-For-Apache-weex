...
var defaultLoaders = {
  none: '',
  main: _path3.default.resolve(loaderPath, 'loader.js'),
  extract: _path3.default.resolve(loaderPath, 'extract.js'),
  template: _path3.default.resolve(loaderPath, 'template.js'),
  style: _path3.default.resolve(loaderPath, 'style.js'),
  script: _path3.default.resolve(loaderPath, 'script.js'),
  json: _path3.default.resolve(loaderPath, 'json.js'),
...
function loader(source) {
  ...
  if (_path3.default.extname(this.resourcePath).match(/\.vue/)) {
  ...
  var filename = _path3.default.relative('.', resourcePath);
  ...
  if (frag.deps.length) {
    ...
    try {
      for (var _iterator = frag.deps[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        var filepath = _path3.default.resolve(_path3.default.dirname(resourcePath), dep + '.we');
